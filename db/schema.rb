...
ActiveRecord::Schema.define(version: 20160611213018) do
  ...
  create_table "long_term_treatments", force: :cascade do |t|
  ...
  add_index "long_term_treatments", ["patient_doctor_id"], name: "index_long_term_treatments_on_patient_doctor_id", unique: true, using: :btree
